      ...
      <main className="mx-auto max-w-4xl px-6 py-6 lg:px-16 lg:py-10">
        ...
        <div className="mt-8">
          <h1 className="text-3xl font-extrabold text-brand-black">
            CAC & Compliance <span className="text-brand-gray">· {CAC_TYPES.length} types</span>
          </h1>
          <p className="mt-2 text-brand-gray">
            Government portal filings, handled end to end. Every filing is quoted after
            review — government fees are itemised in your quote.
          </p>
        </div>
          ...
          {CAC_TYPES.map((t) => (
            ...
            >
              <div>
                ...
                <p className="mt-2 text-xs font-semibold uppercase tracking-wide text-brand-yellow-dark">
                  {t.turnaround}
                </p>
              </div>
